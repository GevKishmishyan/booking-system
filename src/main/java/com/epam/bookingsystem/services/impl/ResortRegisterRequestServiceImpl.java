...
public class ResortRegisterRequestServiceImpl implements ResortRegisterRequestService {
    ...
    @Override
    public List<ResortRegisterRequest> getAll() {
       ...
       // return MyMapperForAll.resortRegisterRequestList_To_responseDTOList(requestList);
        return resortRegisterRequestRepository.findAll();
    }

    @Override
    public ResortRegisterRequest save(ResortRegisterRequest resortRegisterRequest) {
        return resortRegisterRequestRepository.save(resortRegisterRequest);
    }
